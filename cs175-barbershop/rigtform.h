...
inline RigTForm interpolateCatmullRom(const RigTForm &tform0,
                                      const RigTForm &tform1,
                                      const RigTForm &tform2,
                                      const RigTForm &tform3, double t) {
    return RigTForm(
        interpolateCatmullRom(tform0.getTranslation(), tform1.getTranslation(),
                              tform2.getTranslation(), tform3.getTranslation(),
                              t),
        interpolateCatmullRom(tform0.getRotation(), tform1.getRotation(),
                              tform2.getRotation(), tform3.getRotation(), t));
}
